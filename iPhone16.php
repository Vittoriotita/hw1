...
<body>
    ...
    <section id="welcome-section">
        <div id="welcome-left-container">
            <h1>Acquista iPhone 16</h1>
            <span>Da € 40,79 al mese o € 979</span>
      ...
      <div id="buy-right-container">
        <div id="buy-right-text-container">
          ...
          <form id="buy-buttons-container">
            <label class="form-label-button" for="model" data-size="iPhone 16">
              <input class="button-input" type="radio" name="model" id="model" value="iPhone 16">
              <div class="buy-buttons-text-container">
                <div id="buy-buttons-left-text">
                  <span id="phone">iPhone 16</span>
            ...
            <label class="form-label-button" for="model1" data-size="iPhone 16 Plus">
              <input class="button-input" type="radio" name="model1" id="model1" value="iPhone 16 Plus">
              <div class="buy-buttons-text-container">
                <div id="buy-buttons-left-text">
                  <span id="phone">iPhone 16 Plus</span>
                  <span id="size">Display da 6,7"</span> 
                </div>
              </div>
            </label>
