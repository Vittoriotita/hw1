...
<head>
    ...
    <title>iPhone</title>
    <link rel="stylesheet" href="iPhone.css?v=<?php echo time(); ?>">
    <script src="iPhone.js?v=<?php echo time(); ?>" defer></script>
</head>
<body>
    ...
    <div class="announcement-container">
        <p class="announcement-text">Fino al 18 giugno, con la permuta ottieni ancora più credito per un nuovo iPhone.* <a href="">Acquista iPhone ></a></p>
    </div>
    <section id="static-section">
        <header class="welcome-header">
            <?php echo "<h1 class='welcome-header-title'>Confronta i modelli di iPhone, ".$_SESSION['_agora_username']."</h1>"; ?>
            <p><a href="">Acquista un iPhone ></a></p>
            <p>Ti serve un consiglio? <a href="">Chiedi al nostro team di Specialisti ></a></p>
        </header>       
    </section>
    <div id="form-container">
        <select name="scelta-1" data-index="1">
        ...
        <select name="scelta-2" data-index="2">
            <option value="iPhone 16">iPhone 16</option>
            <option value="iPhone 16 Plus">iPhone 16 Plus</option>
            <option value="iPhone 16 Pro">iPhone 16 Pro</option>
            <option value="iPhone 16 Pro Max">iPhone 16 Pro Max</option>
        ...
        <select name="scelta-3" data-index="3">
            <option value="iPhone 16e">iPhone 16e</option>
            <option value="iPhone 16 Plus">iPhone 16 Plus</option>
            <option value="iPhone 16">iPhone 16</option>
            <option value="iPhone 16 Pro">iPhone 16 Pro</option>
    ...
    <div id="main-container">
      <div id="phone-container-1" class="phone-container">
        <img src="https://www.apple.com/v/iphone/compare/ai/images/overview/compare_iphone15_pro_max_black_titanium__dek1z0fhosom_large.jpg" alt="">
        <hr class="divider">
        <div class="phone-details">
          <span>A partire da € 62.00 al mese o € 1499.00</span>
          <a class="acquista" href="iPhone16pro.php">Acquista</a>
        </div>
      </div>
      <div id="phone-container-2" class="phone-container">
        <img src="https://www.apple.com/v/iphone/compare/ai/images/overview/compare_iphone16_black__ck6xpqbw7fma_large.jpg" alt="">
        <hr class="divider">
        <div class="phone-details">
          <span>A partire da € 50.00 al mese o € 1199.00</span>
          <a class="acquista" href="iPhone16.php">Acquista</a>
        </div>
      </div>
      <div id="phone-container-3" class="phone-container">
        <img src="https://www.apple.com/v/iphone/compare/ai/images/overview/compare_iphone16e_black__cwfsksm6qjqu_large.jpg" alt="">
        <hr class="divider">
        <div class="phone-details">
          <span>A partire da € 42.00 al mese o € 999.00</span>
          <a class="acquista" href="iPhone16e.php">Acquista</a>
        </div>
      </div>
    </div>
