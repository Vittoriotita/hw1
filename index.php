...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="hmw1.css" />
    ...
    <header id="global-header">
      ...
      <div id="menu-dropdown-shop" class="menu-dropdown hidden">
        <div class="menu-dropdown-content">
          ...
          <p><a href="login.php">Accedi</a> o <a href="signup.php">Iscriviti</a> per vedere gli articoli salvati</p>
          <div class="menu-dropdown-links">
            <p>Il mio profilo</p>
            <ul>
              <li>
              ...
              <li>
                <svg height="16" viewBox="0 0 9 16" width="9" xmlns="http://www.w3.org/2000/svg"><path d="m8.6124 8.1035-2.99 2.99a.5.5 0 0 1 -.7071-.7071l2.1366-2.1364h-6.316a.5.5 0 0 1 0-1h6.316l-2.1368-2.1367a.5.5 0 0 1 .7071-.7071l2.99 2.99a.5.5 0 0 1 .0002.7073z"></path></svg>
                <a href="https://www.apple.com/it/">I tuoi articoli salvati</a>
              </li>
              <li>
                <svg height="16" viewBox="0 0 9 16" width="9" xmlns="http://www.w3.org/2000/svg"><path d="m8.6124 8.1035-2.99 2.99a.5.5 0 0 1 -.7071-.7071l2.1366-2.1364h-6.316a.5.5 0 0 1 0-1h6.316l-2.1368-2.1367a.5.5 0 0 1 .7071-.7071l2.99 2.99a.5.5 0 0 1 .0002.7073z"></path></svg>
    ...
    <section id="main-section">
      ...
      <div id="secondary-banner" class="banner">
        ...
        <div class="movingBanner">
          <span class="movingSpan">Stay Hungry, Stay Foolish</span>
        </div>
        <div id="video-box">
        </div>
      ...
      <div id="contenitore-footer">
        ...
        <nav id="footer-nav">
          ...
          <div class="footer-column">
            ...
            <ul class="footer-column-list">
              <li><a class="footer-nav-link" href="login.php">Account</a></li>
