...
<body>
    ...
    <section id="welcome-section">
        <div id="welcome-left-container">
            <h1>Acquista iPhone 16e</h1>
            <span>Da € 42,00 al mese o € 999,00</span>
    ...
    <section id="buy-section">
      <div id="buy-left-container">
        <img src="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/iphone-16e-finish-unselect-gallery-1-202502_GEO_EMEA?wid=5120&hei=2880&fmt=p-jpg&qlt=80&.v=bGxrMXRYSllVRTZGbi82ZklwWis2MnJ2UHBBV3orM3VMYVQ4cFJXZmQxWGZNWmFhT21IZ3FqU1Z3N0hPMGdxUnkwdVFSV09pcktsRHViVExZS1gwSzBVTDNOcU9BNmNDSm9MR2pxN2NDVDZXSzZTYlF6T2d6NU1LRjVGajAvU2ZWSzlOSHE5YlpTVlcwM1VqWmxaczZB&traceId=1">
      </div>
      <div id="buy-right-container">
        <div id="buy-right-text-container">
          ...
          <form id="buy-buttons-container">
            <label class="form-label-button" for="model1" data-size="iPhone 16e">
              <input class="button-input" type="radio" name="model1" id="model1" value="iPhone 16e">
              <div class="buy-buttons-text-container">
                <div id="buy-buttons-left-text">
                  <span id="phone">iPhone 16e</span>
                  <span id="size">Display da 6,1"</span> 
                </div>
              </div>
            </label>
