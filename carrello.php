<?php
    ...
    $update_cost_query = "UPDATE carrello SET prezzo_totale = prezzo_totale + (SELECT prezzo FROM prodotti WHERE nome = '$item') WHERE id = '$utente_id'";
    $res_update_cost = mysqli_query($conn, $update_cost_query);
