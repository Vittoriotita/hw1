...
<head>
    ...
    <link rel="stylesheet" href="airpods.css?v=<?php echo time(); ?>">
    <script src="airpods.js?v=<?php echo time(); ?>" defer></script>
    <title>Airpods</title>
</head>
<body>
        ...
        <nav id="global-nav">
          <ul>
            ...
            <li class="link-container">
              <a href="https://www.apple.com/it/" data-id="0">Store</a>
            </li>
            <li class="link-container">
              <a href="https://www.apple.com/it/" data-id="1">Mac</a>
            </li>
            <li class="link-container">
              <a href="https://www.apple.com/it/" data-id="2">iPad</a>
            </li>
            <li class="link-container">
              <a href="iPhone.php" data-id="3">iPhone</a>
            </li>
            <li class="link-container">
              <a href="https://www.apple.com/it/" data-id="4">Watch</a>
            </li>
            <li class="link-container">
              <a href="airpods.php" data-id="5">AirPods</a>
            </li>
            <li class="link-container">
              <a href="https://www.apple.com/it/" data-id="6">TV & Casa</a>
            </li>
            <li class="link-container">
              <a href="https://www.apple.com/it/" data-id="7">Intrattenimento</a>
            </li>
            <li class="link-container">
              <a href="https://www.apple.com/it/" data-id="8">Accessori</a>
            </li>
            <li class="link-container">
              <a href="https://www.apple.com/it/" data-id="9">Supporto</a>
            </li>
            <li class="link-container">
    ...
    <section class="announcement-section">
        <div class="announcement-container">
            <p class="announcement-text">3 mesi di Apple Music gratis per te, con il tuo modello di AirPods.* <a href="">Scopri di più ></a></p>
        </div>
        <ul class="announcement-list">
            <li class="announcement-item">
                <img src="https://www.apple.com/v/airpods/w/images/chapternav/airpods_4__fqax1brwh46e_large.svg" alt="">
            </li>
            <li class="announcement-item">
                <img src="https://www.apple.com/v/airpods/w/images/chapternav/airpods_pro_light__ets5a19rt3au_large.svg" alt="">
            </li>
            <li class="announcement-item">
                <img src="https://www.apple.com/v/airpods/w/images/chapternav/airpods_max_light__cvaaddhgazqu_large.svg" alt="">
            </li>
            <li class="announcement-item">
                <img src="https://www.apple.com/v/airpods/w/images/chapternav/airpods_compare_light__cmuvdvbxj1w2_large.svg" alt="">
            </li>
            <li class="announcement-item">
                <img src="https://www.apple.com/v/airpods/w/images/chapternav/apple_music_light__fexraacz3dme_large.svg" alt="">
            </li>
        </ul>
    </section>
    <section id="static-section">
        <header class="welcome-header">
            <h1 class="welcome-header-title">Qual è il modello di AirPods giusto per te?</h1>
            <p>Ti serve un consiglio? <a href="">Chiedi al nostro team di Specialisti ></a></p>
        </header>    
        <div id="main-container">
            <div class="airpod-container" data-id="Airpods 4">
                <div class="image-wrapper">
                    <img src="https://www.apple.com/v/airpods/shared/compare/e/images/compare/compare_airpods_4__fy4e25bzx1u2_large.png" alt="">
                    <h2>Airpods 4</h2>
                </div>
                <hr class="divider">
                <div class="airpod-details">
                  <span>€ 149</span>
                  <a class="acquista" href="">Acquista</a>
                </div>
                <div class="airpod-details">
                    <span>Suono e comfort di ultima generazione.</span>
                </div>
            </div>
            <div class="airpod-container" data-id="Airpods 4 Noise Cancellation">
                <div class="image-wrapper">
                    <img src="https://www.apple.com/v/airpods/shared/compare/e/images/compare/compare_airpods_4_noise_cancellation__fnt5kzpmite2_large.png" alt="">
                    <h2>Airpods 4</h2>
                </div>
                <hr class="divider">
                <div class="airpod-details">
                ...
                <div class="airpod-details">
                    <span>Suono, comfort, controllo del rumore: una nuova era.</span>
                </div>
            </div>
            <div class="airpod-container" data-id="Airpods Pro 2">
                <div class="image-wrapper">
                    <img src="https://www.apple.com/v/airpods/shared/compare/e/images/compare/compare_airpods_pro_2__c3r137ebxwae_large.png" alt="">
                    <h2>Airpods Pro 2</h2>
                </div>
                <hr class="divider">
                <div class="airpod-details">
                ...
                <div class="airpod-details">
                    <span>Cancellazione attiva del rumore di livello pro e innovazioni per la salute dell’udito.</span>
                </div>
            </div>
            <div class="airpod-container" data-id="Airpods Max">
                <div class="image-wrapper">
                    <img src="https://www.apple.com/v/airpods/shared/compare/e/images/compare/compare_airpods_max__b14s2x6q07rm_large.png" alt="">
                    <h2>Airpods Max</h2>
                </div>
                <hr class="divider">
                <div class="airpod-details">
                ...
                <div class="airpod-details">
                    <span>Cuffie over-ear per un ascolto davvero sublime.</span>
                </div>
            </div>
          </div>   
    </section>
